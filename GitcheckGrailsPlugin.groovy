class GitcheckGrailsPlugin {
    ...
    def title = "Gitcheck Plugin" // Headline display name of the plugin
    def author = "Robert Oschwald"
    def authorEmail = "roos@symentis.com"
    def description = '''\
Provides the ability to check Git respoitory status, e.g. uncommited files, missing updates, etc. while creating a war file.
'''
